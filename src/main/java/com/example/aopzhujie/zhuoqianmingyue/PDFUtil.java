...
public class PDFUtil {
	...
	public static void main(String[] args) throws MalformedURLException, FileNotFoundException, DocumentException, IOException {
		...
		String imagePath = PDFUtil.class.getClassLoader().getResource("certificate2.png").getPath();
		imagePath=imagePath.replace("%e6%a1%86%e6%9e%b6%e5%ad%a6%e4%b9%a0","框架学习");
		String pdfFilePath = "d:/pdf/" +71+ ".pdf";
