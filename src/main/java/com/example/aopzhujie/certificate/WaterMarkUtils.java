...
public class WaterMarkUtils {
     ...
     * @param font 水印字体
     */
    public void addWaterMark(String srcImgPath, String tarImgPath, String waterMarkContent,String waterMarkContentTime,Color markContentColor,Font font) {
        ...
        try {
            ...
            int watermarkLength1 = getWatermarkLength(waterMarkContent, g);
    ...
    public static void main(String[] args) {
        ...
        String tarImgPath="D:/pdf/牟欣2.jpg"; //待存储的地址
        ...
        new WaterMarkUtils().addWaterMark(srcImgPath, tarImgPath, waterMarkContentName,waterMarkContentTime, color,font);
