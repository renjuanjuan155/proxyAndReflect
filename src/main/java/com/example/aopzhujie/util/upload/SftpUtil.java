...
import com.example.aopzhujie.config.SysFtpConfig;
...
//        SysFtpConfig sysFtpConfig = new SysFtpConfig();
//        sysFtpConfig.setUsername("portalstatic");
//        sysFtpConfig.setPassword("portalstatic%1qaz2wsx");
//        sysFtpConfig.setHost("118.190.142.115");
//        sysFtpConfig.setPort(22);
//        sysFtpConfig.setRootpath("/data/bamboodata/");
//        sysFtpConfig.setOrigin("18.190.142.115/");
//        sysFtpConfig.setConnecttime(5);
//		SftpUtil sftp = new SftpUtil(sysFtpConfig);
//		try {
//			sftp.connect();
////			sftp.delete("/data/bamboodata/portal_pic/item/", "S20150815113255214171.jpg");
//			sftp.download("/data/bamboodata/portal_pic/item/",
//                    "9da4eaf49ebd441eb2634f5328682f62.jpg",
//                    "D:\\ideaproject\\information\\portal-parent\\portal-common\\src\\main\\java\\com\\portal\\util\\upload\\");
//			sftp.download("/data/bamboodata/portal_video/item/",
//                    "ca47afc402364f7393d35da6268b7164.mp4",
//                    "D:\\ideaproject\\information\\portal-parent\\portal-common\\src\\main\\java\\com\\portal\\util\\upload\\");
//
//			sftp.disconnect();
//		} catch (Exception e) {
